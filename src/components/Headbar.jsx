    ...
    <header id="Headbar">
      <div className="flex flex-col pt-8">
        ...
        <div className="text-center">
          ...
          <h1 className="text-h5 m-0 p-0 font-semibold font-poppins">
            <a
              href="#"
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-4 mb-8">
            {" "}
            {/* Added mb-8 for spacing before nav */}
          ...
          <ul className="m-0 p-0 flex flex-col gap-1 w-full">
            ...
            {headbarItems.map((item) => (
              <li key={item.id}>
                ...
                >
                  <span className="flex w-[30px] items-center justify-center text-lg mr-2">
                    {" "}
                    {/* Ensure icon is centered and sized */}
                    <FontAwesomeIcon
                      icon={item.icon}
                      className="transition-colors duration-200"
                    />{" "}
                    {/* Group hover will handle color */}
                  </span>
